...
let bookmarkedQuestions = JSON.parse(localStorage.getItem('dsa_bookmarks')) || [];
let userProgress = JSON.parse(localStorage.getItem('dsa_progress')) || {
...
function renderQuestion() {
    ...
    const typeNames = { 'judge': '判断题', 'choice': '选择题', 'design': '分析题', 'comprehensive': '问答题' };
...
function saveProgress() {
    ...
    localStorage.setItem('dsa_bookmarks', JSON.stringify(bookmarkedQuestions));
}
